...
const editAccount: React.FC<editAccountProps> = ({}) => {
  ...
  const [emailEditMode, setEmailEditMode] = useState<"edit" | "readOnly">(
    "readOnly"
  );
  const [bankEditMode, setBankEditMode] = useState<"edit" | "readOnly">(
    "readOnly"
  );
  const [accountEditMode, setAccountEditMode] = useState<"edit" | "readOnly">(
    "readOnly"
  );
